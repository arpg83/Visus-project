...
public class ClientesView extends Div implements BeforeEnterObserver {
    ...
    private TextField fechaJubilacion;
    private TextField fechaBaja;
    private TextField fechaActualizacion;
    private TextField fechaIngreso;
    private TextField fechaUltimaCompra;
    ...
    private void createEditorLayout(SplitLayout splitLayout) {
        ...
        fechaNacimiento = new TextField("Fecha Nacimiento");
        fechaJubilacion = new TextField("Fecha Jubilacion");
        fechaBaja = new TextField("Fecha Baja");
        fechaActualizacion = new TextField("Fecha Actualizacion");
        fechaIngreso = new TextField("Fecha Ingreso");
        fechaUltimaCompra = new TextField("Fecha Ultima Compra");
